...
// same landscape φ motif as the hero (black-bg raster; `screen` blend drops the black)
const xrayB64 = readFileSync(join(ROOT, 'public/assets/img/hero-fib.webp')).toString('base64');
...
const html = `<!doctype html><html><head><meta charset="utf-8"><style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .xr{position:absolute;right:-64px;top:50%;transform:translateY(-50%);width:800px;opacity:.62;mix-blend-mode:screen}
  .xr img{width:100%;display:block}
  ...
  <div class="xr"><img src="data:image/webp;base64,${xrayB64}"></div>
  <div class="left">
